...
public class FriendRequestController {
	...
	public String sendFriendRequest(Model model, @PathVariable Long id, Principal principal) {
		...
		logger.infoLog("The user with email: " + loggedInUser.getEmail()
				+ " has send friend request to user with email: " + requestedUser.getEmail() + ".");
	...
	public String acceptRequest(@PathVariable Long id, Model model, Principal principal) {
		...
		logger.infoLog("The user with email: " + loggedInUser.getEmail()
				+ " has accepted the friend request of the user with email: " + requestingUser.getEmail() + ".");
	...
	public String getFriendRequests(Model model, Pageable pageable, Principal principal) {
		...
		logger.infoLog("The user with email: " + loggedInUser.getEmail() + " has listed their friend requests.");
