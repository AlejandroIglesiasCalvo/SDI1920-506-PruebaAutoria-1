...
public class PublicationsController {
	...
	public String savePublication(@ModelAttribute Publication publication, BindingResult result, Principal principal,
		...
		logger.infoLog("User with email \"" + loggedInUser.getEmail() + "\" has created a new publication with title \""
	...
	public String listPublications(Model model, Pageable pageable, Principal principal) {
		...
		logger.infoLog("User with email \"" + loggedInUser.getEmail() + "\" has listed all his own publications");
	...
	public String getDetails(Model model, @PathVariable Long id) {
		...
		if (loggedInUser.equals(publication.getOwner())
			...
			logger.infoLog("User with email \"" + loggedInUser.getEmail()
					+ "\" has shown details of publication with title \"" + publication.getTitle() + "\"");
	...
	public String getPublicationsByUser(Model model, @PathVariable Long id, Pageable pageable) {
		...
		if (friendshipService.areFriends(loggedInUser, user) != null) {
			...
			model.addAttribute("page", publications);
			logger.infoLog(
					"User with email \"" + loggedInUser.getEmail() + "\" has listed all his friends publications");
